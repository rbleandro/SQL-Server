...
/****** Object:  Job [Adela_User_List]    Script Date: 5/23/2019 5:42:07 PM ******/
DECLARE @jobname VARCHAR(500)
SELECT @jobname=name FROM msdb.dbo.sysjobs WHERE name = N'Adela_User_List'
...
/****** Object:  Job [Adela_User_List]    Script Date: 5/23/2019 4:58:07 PM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 5/23/2019 4:58:07 PM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Execute_Statement]    Script Date: 5/23/2019 4:58:07 PM ******/
