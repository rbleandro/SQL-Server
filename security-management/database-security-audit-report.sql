IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].SecAuditPermissions') AND type IN (N'P', N'PC'))
BEGIN
...
as
DECLARE @p_userName NVARCHAR(50) = '' -- Specify up to five characters here (or none for all users)
